...
class _RadioPlayerScreenState extends State<RadioPlayerScreen> {
  ...
  final List<Map<String, String>> _stations = [
    {
      "name": "Sunshine Radio",
      "url": "https://chmedia.streamabc.net/79-rsunshine-mp3-192-4746851...",
      "image": "assets/sunshine_logo.png"
    },
    {
      "name": "Radio Argovia",
      "url": "https://chmedia.streamabc.net/79-argovia-mp3-192-3024993...",
      "image": "assets/argovia_logo.png"
    },
    {
      "name": "Radio Pilatus",
      "url": "https://chmedia.streamabc.net/79-pilatus-mp3-192-4664468...",
